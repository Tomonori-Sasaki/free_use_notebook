...
class YoutubesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create youtube" do
    assert_difference('Youtube.count') do
      post youtubes_url, params: { youtube: { content: @youtube.content, name: @youtube.name, rank: @youtube.rank } }
    end
  ...
  test "should update youtube" do
    patch youtube_url(@youtube), params: { youtube: { content: @youtube.content, name: @youtube.name, rank: @youtube.rank } }
